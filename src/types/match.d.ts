...
export interface ParticipantDto {
     ...
     * of the most likely position played by a player. The individualPosition is the best guess for which
     * position the player actually played in isolation of anything else. The teamPosition is the best guess
     * for which position the player actually played if we add the constraint that each team must have one
     * top player, one jungle, one middle, etc. Generally the recommendation is to use the teamPosition field
